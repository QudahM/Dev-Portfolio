...
const defaultExperiences: WorkExperience[] = [
  {
    ...
    description: [
      ...
      "Optimized data storage and retrieval by refining MongoDB schema design and indexing, improving accessibility for over 100,000+ Kafka messages across 100+ topics.",
  ...
  },
  {
    ...
    description: [
      "Enhanced user interface functionality by integrating an external pop-up feature utilizing React to enable seamless official document rotations, leading to a 12% increase in user engagement and 20% less paper usage.",
